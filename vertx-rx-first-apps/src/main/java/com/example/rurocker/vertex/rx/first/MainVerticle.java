package com.example.rurocker.vertex.rx.first;
...
public class MainVerticle extends AbstractVerticle {
	...
	public void start() throws Exception {
		...
		// We start the server using rxListen returning a // Single of HTTP server. We
		// need to subscribe to // trigger the operation
